...
mol = init_molecule('CH3')
opt_mol = opt_molecule(mol)
slab = opt_slab()

ads = opt_molecule(init_molecule('CH3'))
screening_results = site_screening(slab, ads, center_xy='site', use_all_sites=True, workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CH3/Screening_Data')
...
images_trans, result_trans = prepare_neb_calculation(
        ...
        workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CH3/NEB_Translation'
    )
...
images_rot, result_rot = prepare_neb_calculation(
        ...
        workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CH3/NEB_Rotation'
    )
