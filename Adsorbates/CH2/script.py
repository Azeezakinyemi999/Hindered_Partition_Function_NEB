...
screening_results = site_screening(slab, ads, center_xy='site', use_all_sites=True, workdir='Screening_Data')
...
images_trans, result_trans = prepare_neb_calculation(
        ...
        workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CH2/NEB_Translation'
    )
...
images_rot, result_rot = prepare_neb_calculation(
        ...
        workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CH2/NEB_Rotation'
    )
