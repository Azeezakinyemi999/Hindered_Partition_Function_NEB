...
screening_results = site_screening(slab, ads, center_xy='site', use_all_sites=True, workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/Screening_Data')

# Validate all screening files
validation = validate_screening_files('/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/Screening_Data')

clean_incomplete_files('/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/Screening_Data', dry_run=True)

# Recover the missing JSON and summary files from your valid pickle file
recover_screening_files('/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/Screening_Data')

screening_results = load_screening_results('/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/Screening_Data/screening_results.pkl')
...
images_trans, result_trans = prepare_neb_calculation(
        ...
        workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/NEB_Translation'
    )
...
images_rot, result_rot = prepare_neb_calculation(
        ...
        workdir='/projects/westgroup/lekia.p/NEB/Adsorbates/CO2/NEB_Rotation'
    )
